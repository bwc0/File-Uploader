...
public class StorageServiceImplementation implements StorageService {
    ...
    public void store(MultipartFile file) {
        ...
        try {
            ...
            if(filename.contains("..")) {
                // Security Check
                throw new StorageFileNotFoundException("Cannot store file with relative path outside current " +
                        "directory " + filename);
            }
            ...
            throw new StorageFileNotFoundException("Failed to store file: " + filename, e);
        }
    }
    ...
    @Override
    public Path load(MultipartFile file) {
        return rootLocation.resolve(file.getName());
    }
